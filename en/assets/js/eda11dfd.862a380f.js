"use strict";(self.webpackChunkdocs=self.webpackChunkdocs||[]).push([[4659],{54479:(e,t,a)=>{a.d(t,{D:()=>m,Z:()=>s});var r=a(25773),n=a(27378),i=a(67468),o=a(45666);const l=i.ZP.div`
...
`,Z=(0,l.ZP)(p.Z)`
  ...
  left: 0;
  width: 280px;
`,w=(0,n.forwardRef)(((e,t)=>{let{locale:a=c.Z,...i}=e;const{date:o,changeYear:l}=i;let s=o;return n.createElement(f,(0,r.Z)({ref:t},i),n.createElement(y,null,n.createElement(b,{kind:u.Z.kinds.tertiary,size:h.Z.sizes.sm,onClick:()=>l((0,m.default)(s)-1),"aria-controls":"headerNavigation"},n.createElement(g.Z,{id:"previous-year",title:"go to previous year",titleId:"previous-year"})),n.createElement(Z,{id:"headerNavigation","aria-live":"assertive"},(0,m.default)(s)),n.createElement(b,{kind:u.Z.kinds.tertiary,size:h.Z.sizes.sm,onClick:()=>l((0,m.default)(s)+1),"aria-controls":"headerNavigation"},n.createElement(v.Z,{id:"next-year",title:"go to next year",titleId:"next-year"}))))}));w.displayName="DatePicker.YearlyHeader",w.propTypes={locale:o().object};const k=w;var x=a(54571),_=a(64083),z=a(87926),E=a(37811),C=a(17752),$=a(5662),T=a(50046),R=a(38095),P=a(2793);const I="48px",N=l.ZP.div`
  display: flex;
  justify-content: space-between;
  position: absolute;
  width: calc(100% - (var(--size-spacing-04) * 2));
