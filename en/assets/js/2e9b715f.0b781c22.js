"use strict";(self.webpackChunkdocs=self.webpackChunkdocs||[]).push([[8611],{54479:(e,t,a)=>{a.d(t,{D:()=>m,Z:()=>s});var r=a(25773),n=a(27378),i=a(67468),o=a(45666);const l=i.ZP.div`
...
`,Z=(0,l.ZP)(p.Z)`
  ...
  left: 0;
  width: 280px;
`,w=(0,n.forwardRef)(((e,t)=>{let{locale:a=c.Z,...i}=e;const{date:o,changeYear:l}=i;let s=o;return n.createElement(f,(0,r.Z)({ref:t},i),n.createElement(y,null,n.createElement(b,{kind:u.Z.kinds.tertiary,size:h.Z.sizes.sm,onClick:()=>l((0,m.default)(s)-1),"aria-controls":"headerNavigation"},n.createElement(g.Z,{id:"previous-year",title:"go to previous year",titleId:"previous-year"})),n.createElement(Z,{id:"headerNavigation","aria-live":"assertive"},(0,m.default)(s)),n.createElement(b,{kind:u.Z.kinds.tertiary,size:h.Z.sizes.sm,onClick:()=>l((0,m.default)(s)+1),"aria-controls":"headerNavigation"},n.createElement(v.Z,{id:"next-year",title:"go to next year",titleId:"next-year"}))))}));w.displayName="DatePicker.YearlyHeader",w.propTypes={locale:o().object};const x=w;var _=a(54571),k=a(64083),z=a(87926),E=a(37811),C=a(17752),$=a(5662),R=a(50046),S=a(38095),I=a(2793);const N="48px",T=l.ZP.div`
  display: flex;
  justify-content: space-between;
  position: absolute;
  width: calc(100% - (var(--size-spacing-04) * 2));
...
`,L=(0,n.forwardRef)(((e,t)=>{let{locale:a=c.Z,...i}=e;const{monthsShown:o,date:l,decreaseMonth:s,increaseMonth:d,prevMonthButtonDisabled:f,nextMonthButtonDisabled:y,titleAction:b}=i,Z=!R.Z(b)&&{forwardedAs:"div",tabindex:"-1"},w=Array(o).fill(0);let x=document.getElementsByClassName("react-datepicker__month"),N=l;if(o>1&&x.length){const e=x[0].getAttribute("aria-label").replace("month","").trim().split("-").join("/");N=new Date(`${e}/01`)}return n.createElement(T,(0,r.Z)({ref:t},i),n.createElement(P,null,n.createElement(A,{kind:u.Z.kinds.tertiary,onClick:s,disabled:f,"aria-controls":"headerNavigation"},n.createElement(g.Z,{id:"previous-month",title:"go to previous month",titleId:"previous-month"})),n.createElement(S.Z,{id:"headerNavigation","aria-live":"assertive"},w.map(((e,t)=>n.createElement(D,(0,r.Z)({key:`header-${t}`,second:!!t,token:p.Z.tokens.TEXT_MD_BOLD,onClick:b,kind:h.Z.kinds.tertiary,size:h.Z.sizes.md},Z),`${(0,I.G4)(a)[(0,E.default)((0,z.default)(N,t))]} ${(0,m.default)(N)}`)))),n.createElement(A,{kind:u.Z.kinds.tertiary,onClick:d,disabled:y,"aria-controls":"headerNavigation"},n.createElement(v.Z,{id:"next-month",title:"go to next month",titleId:"next-month"}))),n.createElement(P,null,w.map(((e,t)=>n.createElement(M,{as:$.Z.as.ul,key:`weekdays-${t}`},((e,t)=>{const a=(0,_.default)(t,{locale:e});return[].concat([0,1,2,3,4,5,6].map((t=>{const r=(0,k.default)(a,t),i=e.localize.day((0,C.default)(r),{width:"short"});return n.createElement("li",{key:t,className:"react-datepicker__day-name"},i)})))})(a,(0,z.default)(N,t)))))))}));L.displayName="DatePicker.MonthlyHeader",L.propTypes={locale:o().object,titleAction:o().func};const j=L,F="40px",H=l.ZP.div`
...
`,O=(0,n.forwardRef)(((e,t)=>{let{range:a,className:i,titleAction:o,placeholder:l,position:m=O.positions.bottom,selected:u=null,locale:p=c.Z,double:h=!1,yearlyView:g=!1,inline:v=!1,startDate:f=null,endDate:y=null,onChange:b=(()=>{}),dateFormat:Z="dd/MM/yyyy",width:w,..._}=e;(0,s.registerLocale)("locale",p);const k=(0,n.useRef)(t),[z,E]=(0,n.useState)(!1),C=(0,n.useRef)(!0),$=(0,n.useRef)(),R=(0,n.useRef)(),S=(0,n.useRef)(),I=h?2:1;return(0,n.useLayoutEffect)((()=>{if(C.current)return $.current=u,R.current=f,S.current=y,void(C.current=!1);const e=$.current&&!u,t=R.current&&!f,a=S.current&&!y;if(!k.current?.calendar?.componentNode)return;if(e||t||a){k.current.calendar.componentNode.querySelectorAll(".react-datepicker__day--selected, .react-datepicker__day--keyboard-selected").forEach((e=>{e.classList.remove("react-datepicker__day--selected"),e.classList.remove("react-datepicker__day--keyboard-selected")}))}const r=k.current.calendar.componentNode.querySelector(".react-datepicker__day--keyboard-selected"),n=k.current.calendar.componentNode.querySelector(".react-datepicker__day--selected");r&&n&&(r.classList.remove("react-datepicker__day--keyboard-selected"),n.classList.add("react-datepicker__day--keyboard-selected")),$.current=u,R.current=f,S.current=y}),[u,f,y,v]),(0,n.useLayoutEffect)((()=>{if(g&&(z||v)){if(!k.current?.calendar?.componentNode)return;const e=Array.from(k.current.calendar.componentNode.querySelectorAll(".react-datepicker__month-text"));k.current.calendar.componentNode.querySelectorAll(".react-datepicker__month-wrapper").forEach((t=>{const a=e.splice(0,4);if(a.length)return a.map((e=>t.appendChild(e)));t.style.display="none"}))}}),[g,z,v]),n.createElement(H,{$monthsShown:h,$yearlyView:g,className:i,$inline:v,$width:w},n.createElement(d(),(0,r.Z)({selected:u,onCalendarClose:()=>E(!1),onCalendarOpen:()=>E(!0),renderCustomHeader:e=>(e=>g?n.createElement(x,(0,r.Z)({locale:p},e)):n.createElement(j,(0,r.Z)({titleAction:o,monthsShown:I,locale:p},e)))(e),locale:"locale",monthsShown:I,popperPlacement:m,showPopperArrow:!1,showMonthYearPicker:g,inline:v,ref:k,placeholderText:l,startDate:f,endDate:y,onChange:b,dateFormat:Z},_)))}));O.displayName="DatePickerBase",O.positions={top:"top-start",bottom:"bottom-start"},O.propTypes={position:o().oneOf([O.positions.top,O.positions.bottom]),selected:o().instanceOf(Date),startDate:o().instanceOf(Date),endDate:o().instanceOf(Date),inline:o().bool,onChange:o().func,locale:o().object,dateFormat:o().string,double:o().bool,yearlyView:o().bool,titleAction:o().func,placeholder:o().string};const q=O},81583:(e,t,a)=>{a.d(t,{Z:()=>y});var r=a(25773),n=a(27378),i=a(23615),o=a.n(i),l=a(67468),s=a(51288),d=a(55575),c=a(3859),m=a(73647),u=a(41703),p=a(2793);const h=(0,l.ZP)(d.Z)``,g=l.ZP.span`
  display: inline-flex;
  align-items: center;
  font: var(--text-md-bold);
  background-color: var(--neutral-surface);
`,v=l.ZP.div`
  ...
  border-radius: var(--border-radius-md);
  background-color: var(--neutral-surface);
`,f=(0,n.forwardRef)(((e,t)=>{let{value:a,className:i,startDate:o="",endDate:l="",onStartChange:d=(()=>{}),onEndChange:f=(()=>{}),onChange:y=(()=>{}),firstInputRef:b=null,secondInputRef:Z=null,dateFormat:w="dd/MM/yyyy",locale:x=s.Z,double:_=!1,...k}=e;const[z,E]=(0,n.useState)(o),[C,$]=(0,n.useState)(l);let R=(0,n.useRef)(null),S=(0,n.useRef)(null);(0,n.useEffect)((()=>{E(o)}),[o]),(0,n.useEffect)((()=>{$(l)}),[l]);const I=e=>{const t=!c.Z(e.target.value,w.length);m.Z(e.target,[R.current])&&(E(e.target.value),t&&(d((0,p.sG)(e.target.value,w,x)),y(e))),m.Z(e.target,[S.current])&&($(e.target.value),t&&(f((0,p.sG)(e.target.value,w,x)),y(e)))};return n.createElement(v,{ref:t},_?n.createElement(n.Fragment,null,n.createElement(h,(0,r.Z)({prefix:n.createElement(u.Z,{title:"Datepicker",titleId:"datepicker-input"}),rootRef:R,ref:b,className:`range-start datepicker-input ${i}`,type:"text",value:z,onChange:I},k)),n.createElement(g,null,"-"),n.createElement(h,(0,r.Z)({rootRef:S,ref:Z,className:`range-end datepicker-input ${i}`,type:"text",value:C,onChange:I},k))):n.createElement(h,(0,r.Z)({prefix:n.createElement(u.Z,{title:"Datepicker",titleId:"datepicker-input"}),value:a,onChange:y,className:`datepicker-input ${i}`},k,{ref:t})))}));f.displayName="DatePickerInput",f.propTypes={placeholder:o().string,startDate:o().string,endDate:o().string,onStartChange:o().func,onEndChange:o().func,locale:o().object,dateFormat:o().string,double:o().bool,firstInputRef:o().oneOfType([o().func,o().shape({current:o().any})]),secondInputRef:o().oneOfType([o().func,o().shape({current:o().any})])};const y=f},12958:(e,t,a)=>{a.d(t,{Z:()=>v});var r=a(25773),n=a(27378),i=a(23615),o=a.n(i),l=a(67468),s=a(51288),d=a(61380),c=a(11504),m=a(81583),u=a(2793);const p=(0,l.ZP)(c.Z)`
